...
Die Eigenbasis $B$ wird gefunden, indem allen Eigenvektoren $v_i$ (Siehe \verweiseref{eigenvektor}) zusammengesetzt werden (Die Reihenfolge bestimmt dabei die Ausrichtung). Dies ist nur möglich, wenn für alle Unterräume $\mathbb{R}^n$ ein Eigenvektor verfügbar ist.
