...
\noindent $A$ orthogonalisieren (Siehe \verweiseref{orthogonalisieren}) und $R = Q^{T}A = Q^{-1}A$ berechnen. Achtung: Alle orthogonalisierten Vektoren müssen normalisiert sein $\vec{v}_n = \frac{\vec{v}_n}{|\vec{v}_n|}$ Matrix $Q$ muss 
